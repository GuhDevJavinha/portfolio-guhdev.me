...
import { EXPERIENCE_ENTRIES, type ExperienceEntry } from "@/_data/about/experience";
...
export function Experience(): ReactNode {
  ...
  const hiddenCount = EXPERIENCE_ENTRIES.length - Math.floor(COLLAPSED_COUNT);
    ...
    <div className="flex flex-col gap-3">
      ...
      >
        ...
        {hiddenCount > 0 && (
          ...
          >
            {open ? t.about.showLess : t.about.showMore(hiddenCount)}
            <motion.span
